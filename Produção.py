...
class StorageMenu:
    ...
    def create_main_content(self, root):
        ...
        table_container = ctk.CTkFrame(main_content, fg_color=self.colors["table_bg"])
        ...
        for row in range(1, 3):
            for col, _ in enumerate(headers):
                ...
                row_label.grid(row=row, column=col, padx=10, pady=5, sticky="ew")
            table_container.grid_rowconfigure(row, pad=3)
